...
<iframe frameborder="0" scrolling="yes" src="corregirast_mostrardatos.php" style="margin:0px 0px 0px 0px;height:266px;overflow-x:hidden;overflow-y:visibled;" target="_parent" >
</iframe>
</div>
<!--frame------------------------------------------------------------------------------------------------->
