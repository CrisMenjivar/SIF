...
$textos = mysql_query("SELECT * FROM ast WHERE usuario='$usuario1' AND fecha BETWEEN '$years-$meses-$diaI' AND '$years-$meses-$diaF' order by fecha DESC, inicio DESC",$conexion);
