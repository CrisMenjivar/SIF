...
$textos = mysql_query("SELECT * FROM ast WHERE usuario='$usuario1' AND fecha BETWEEN '$years-$mes123-24' AND '$years-$meses-$diaF' order by fecha DESC, inicio DESC",$conexion);
