...
<li><a href="reporteactividades.php" style="color:orange;">Reporte Actividades</a></li>
</ul>
</li>
...
<h2 align="center">Reporte de actividades registradas</h2>
<!--inicio del reporte -->
<div id="box0" >
<div id="box1" style="width:993px;">
<div id="box5" style="width:44px;"> <p style="width:44px;">No.</p></div>
<div id="box2" style="width:322px;"> <p style="width:320px;">Nombre de la actividad</p></div>
<div id="box3" style="width:95px;"> <p style="width:95px;">Estado</p></div>
<div id="box4" style="width:170px;"> <p style="width:168px;">Creado por</p></div>
<div id="box4" style="width:170px;"> <p style="width:168px;">Eliminado por</p></div>
<div id="box4" style="width:95px;"> <p style="width:95px;">Apertura</p></div>
<div id="box4" style="width:95px;"> <p style="width:95px;">Cierre</p></div>
</div>
<div id="box01" style="width:993px;">
<table border="1" style="width:993px;margin-left:0px;" cellpadding="0" cellspacing="0">
<?php
$sql2="select * from actividad order by nombre asc";
...
$actividad=strtr($actividad,'_',' ');
$estado=$actividades['estado'];
$creado=$actividades['creado'];
$eliminado=$actividades['eliminado'];
$fopen=$actividades['fopen'];
$fclose=$actividades['fclose'];

echo '<tr>';
echo '<td width="44px" height="20px" align="center" >'; echo $cantidad; echo'</td>';
echo '<td width="322px" height="20px" >'; echo $actividad; echo'</td>';
echo '<td width="95px" height="20px" align="center" >';  if($estado == "a"){ echo "Disponible";}else{ echo "No disponible";} echo'</td>';
echo '<td width="170px" height="20px" align="center" >'; echo $creado; echo'</td>';
echo '<td width="170px" height="20px" align="center" >'; echo $eliminado; echo'</td>';
echo '<td width="95px" height="20px" align="center" >'; echo $fopen; echo'</td>';
echo '<td width="95px" height="20px" align="center" >'; echo $fclose; echo'</td>';
echo '</tr>';
$cantidad++;
}
?>
