...
<ul>
<li><a href="nuevaactividad.php" style="color:orange;">Agregar Nueva Actividad</a></li>
...
<form name="tipoact" action="nuevaactividadinsertar.php" method="post" onsubmit="return validaractividades(this)" >
<div id="encabezado">
...
<div id="cajas">
<div id="inputtex">
<input type="text"  name="nombreacti" value="" />
</div>
<div id="textos">
<p>Tipo <b> Actividad :</b></p>
</div>
</div>

<div id="cajas" >
<div id="selecttex">
<select name="acitividades" size="1">
<?php
$sql2="select nombre from actividad ";
$result2 = mysql_query($sql2,$conexion);

while ( $actii=mysql_fetch_array($result2) )
{
$acti=$actii['nombre'];
echo "<option value=".$actii['codigo_act'].">".strtr($acti,'_',' ')."</option>";
}
?>
</select>
</div>
<div id="textos">
<p>Tip<b>os Registrados :</b></p>
</div>
</div>
