...
<!--centros de costos -->
<li><a href="nuevo_grupo.php" style="color:orange;">Agregar centro de costo</a></li>
...
<form name="empresas" action="insertar_grupo.php" method="post" onsubmit="return validarccosto(this)" >
...
<input type="text"  name="codigo" value="" style="width: 94px" class="auto-style1"/>
</div>
...
<div id="cajas">
<div id="inputtex" style="width: 62%">
<input type="text"  name="nombre" value="" style="width: 296px;" class="auto-style1" onblur="toUpper(this.form)" />
</div>
<div id="textos" style="width: 24%">
<p style="width: 113px">Nombre CeCo :</p>
</div>
</div>

<div id="cajasbotom">
<div id="inputbotom">
<input type="submit" value="Guardar CeCo"/>
</div>
</div>
</form>
</div>
