...
<title>Eliminar Centro de Costo</title>
...
<li><a href="eliminar_grupo.php" style="color:orange;">Eliminar centro de costo</a></li>
...
<div id="cajas" >
<div id="selecttex" style="width: 58%">
<select name="opcion" size="1" onchange="mitablajax.micompletar(this.form);" style="width: 285px" >
<?php
...
<div id="textos" style="width: 26%">
<p style="width: 132px"><b>Centro de costo:</b></p>
</div>
</div>
...
<input disabled="disabled" style="width: 284px;" type="text"  name="nombre" value=""/>
</div>
...
<div id="cajasbotom">
<div id="inputbotom">
<input type="submit" disabled="" value="Modificar CeCo"/>
</div>
</div>
