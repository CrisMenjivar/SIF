...
<title>Modificar centro de costos</title>
...
<li><a href="modificar_grupo.php" style="color:orange;">Modificar centro de costo</a></li>
<li><a href="eliminar_grupo.php" >Eliminar centro de costo</a></li>
<li><a href="reporte_grupo.php" >Reporte de centros de costos</a></li>
...
<div id="contenedorform" style="left: 0px; top: 0px; height: 275px">
<form name="empresas" action="modificar_procesar.php" method="post" onsubmit="return validarccosto(this)" >

<div id="encabezado">
<p>Modificar centro de costo</p>
</div>

<div id="cajas" >
<div id="selecttex" style="width: 61%">
<select name="opcion" size="1" onchange="mitablajax.micompletar(this.form);" style="width: 302px" >
<?php
$sqlcorre="select * from ccosto where estado='a' order by codigo ASC";
$result2 = mysql_query($sqlcorre,$conexion);
?>
<option value="">Lista de centros de costo</option>
<?php
while ( $correlativos1=mysql_fetch_array($result2) )
{
$code=$correlativos1['codigo'];
...
<div id="textos" style="width: 25%">
<p style="width: 121px;font-size:12px;"><b>Centro de costo:</b></p>
</div>
</div>
...
<input type="text" disabled="disabled"  name="codigo" value="" style="width: 94px" class="auto-style1"/>
</div>
...
<input disabled="disabled" style="width: 305px;" type="text"  name="nombre" value=""/>
</div>
