...
echo '<td width="115px" height="17px"  ';               if( !( $_SESSION['c_check'] == $x ) ){ if( $fila['tipo'] == "o"){ if($fila['dia']%2 == 0){echo 'class="tipo-par"';}else{echo 'class="tipo-impar"';} }else{ if($fila['dia']%2 == 0){echo 'class="par"';}else{echo 'class="impar"';} } }else{ echo ' class="seleccionado" '; } echo ' >'; echo $fila['nomact'];      echo '</td>';
...
echo '<td width="144px" height="17px"  ';               if( !( $_SESSION['c_check'] == $x ) ){ if( $fila['tipo'] == "o"){ if($fila['dia']%2 == 0){echo 'class="tipo-par"';}else{echo 'class="tipo-impar"';} }else{ if($fila['dia']%2 == 0){echo 'class="par"';}else{echo 'class="impar"';} } }else{ echo ' class="seleccionado" '; } echo '>'; echo $fila['cproyecto'];   echo '</td>';
