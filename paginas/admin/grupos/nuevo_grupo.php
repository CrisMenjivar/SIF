...
<ul>
<li><a href="nuevo_grupo.php" style="color:orange;">Agregar Nuevo Grupo</a></li>
...
<form name="empresas" action="insertar_grupo.php" method="post" onsubmit="return validargrupo(this)" >

<div id="encabezado">
<p>Agregar nuevo grupo</p>
</div>
