...
<li><a href="modificar_grupo.php" style="color:orange;">Modificar Grupo</a></li>
...
<div id="contenedorform" style="left: 0px; top: 0px; height: 249px">
<form name="empresas" action="modificar_procesar.php" method="post" onsubmit="return validargrupo(this)" >
...
<p>---------------- Datos del grupo a modificar ----------------</p>
</div>

<div id="cajas">
<div id="inputtex">
<input type="text"  name="nombre" disabled="disabled" value=""/>
</div>
<div id="textos">
<p>Nombre grupo :</p>
</div>
...
<div id="cajasbotom">
<div id="inputbotom">
<input type="submit" disabled="disabled" value="Modificar grupo"/>
</div>
</div>
