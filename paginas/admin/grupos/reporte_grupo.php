...
<li><a href="eliminar_grupo.php" >Eliminar Grupo</a></li>
<li><a href="reporte_grupo.php" style="color:orange;" >Reporte De Grupos</a></li>
</ul>
</li>
...
<h2 align="center">Reporte de grupos registrados</h2>
<!--inicio del reporte -->
<div id="box0">
<div id="box1" style="width:900px;">
<div id="box5" style="width:44px;"> <p style="width:44px;">No.</p></div>
<div id="box2" style="width:400px;"> <p style="width:400px;">Nombre de la actividad</p></div>
...
<div id="box01" style="width:900px;">
<table border="1" style="width:900px;margin-left:0px;" cellpadding="0" cellspacing="0">
<?php
...
echo '<td width="421px" height="20px" >'; echo strtr($actividad,'_',' '); echo'</td>';
