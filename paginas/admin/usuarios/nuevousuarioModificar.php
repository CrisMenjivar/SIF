...
echo "<option value=".$correlativos21.">
						".$correlativos21." - ".$namess."</option>
						"; } ?>
					</select>
				</div>
				<div id="textos">
					<p>
						<b>Seleccione &aacute;rea :</b>
					</p>
				</div>
			</div>
			<div id="cajas">
...
{
$ari=$areass['codigo'];
echo '<option selected="selected" value="'.$ari.'">
								'.$ari."</option>
								"; echo "
...
echo "<option value=".$ari.">
	...
	<div id="conteencabezado" style="margin-top:20px;">
	</div>
</div>
</body>
</html>