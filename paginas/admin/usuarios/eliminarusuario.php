...
<li><a href="eliminarusuario.php" style="color:orange;">Eliminar Usuario</a></li>
...
<form name="sesiones" action="procesar_eliminar.php" method="post" onsubmit="return validarusuario(this)" >
<div id="encabezado">
...
$namesss=$correlativos11['nombre'];
echo "<option value=".$correlativos21.">".$correlativos21." - ".$namesss."</option>";
}
?>
</select>
</div>
