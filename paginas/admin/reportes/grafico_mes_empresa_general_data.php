...
while( $res1=mysql_fetch_array($res) ) //while de las empresas
{
    ...
    $sql12="select sum(totalhoras) as total from ast inner join usuarios on user=usuario where ast.empresa='$codigo' and fecha BETWEEN '$anio-$mes-$diaI' AND '$anio-$mes-$diaF'";
