...
<div id="astdes">
<p>Utilizaci&oacute;n del tiempo general -- SITES </p>
</div>
</div>
...
$sql40="select count(ast.totalhoras) as total from ast where fecha BETWEEN '$anio-$i-$diaI' AND '$anio-$i-$diaF' ";
...
$sql20="select count(ast.totalhoras) as total from ast inner join usuarios on user=usuario where tipoact='$actividadd' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql30="select count(ast.totalhoras) as total from ast where ast.empresa='$empresass' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql3="select ast.empresa,sum(ast.totalhoras) as total from ast where ast.empresa='$empresass' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' group by ast.empresa ASC";
...
<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_3_actividad_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_3_empresa_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_3_utilizacion_grafico.php">
</iframe>
</div>
...
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_3_promedio_grafico.php">
</iframe>
</div>
