...
<title>Reporte de proyectos por &aacute;reas</title>
<style type="text/css">
.auto-style2 {
border-width: 1px;
...
<div id="astdes">
<p>Utilizaci&oacute;n del tiempo en Proyectos -- <?php echo $areass; ?></p>
</div>
</div>
...
$sql4="select sum(totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and cproyecto!='99' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF'";
...
$sql40="select count(ast.totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and cproyecto!='99' and fecha BETWEEN '$anio-$i-$diaI' AND '$anio-$i-$diaF' ";
...
$sql1="select sum(ast.totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and cproyecto!='99' and fecha BETWEEN '$anio-$i-$diaI' AND '$anio-$i-$diaF'";
...
$sql20="select count(ast.totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and tipoact='$actividadd' and cproyecto!='99' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql30="select count(ast.totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and ast.empresa='$empresass' and cproyecto!='99' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql3="select ast.empresa,sum(ast.totalhoras) as total from ast inner join usuarios on user=usuario where area='$areass' and ast.empresa='$empresass' and cproyecto!='99' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' group by ast.empresa ASC";
...
<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_2_actividad_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="area_2_empresa_grafico.php">
</iframe>
</div>

<div id="grafico2" style="margin-left:auto;margin-right:auto;" >
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="882px" height="470px" src="area_2_promedio_grafico.php">
</iframe>
</div>
