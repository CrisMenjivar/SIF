...
{	
	...
	while( $res1=mysql_fetch_array($res) ) //WHILE DE LAS ACTIVIDADES
	{
        ...
        $sql12="select sum(totalhoras) as total from ast inner join usuarios on user=usuario where usuario='$colaborador' and tipoact='$codigo' and fecha BETWEEN '$year-$m1-$diaI' AND '$year-$m1-$diaF'";
