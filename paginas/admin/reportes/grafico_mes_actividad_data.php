...
while( $res1=mysql_fetch_array($res) ) //while de las actividades
{
    ...
    $sql12="select sum(totalhoras) as total from ast inner join usuarios on user=usuario where area='$area' and tipoact='$codigo' and fecha BETWEEN '$anio-$mes-$diaI' AND '$anio-$mes-$diaF'";
