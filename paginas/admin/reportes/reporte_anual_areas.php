...
{
?>
<div id="caja3"><p><b>&Aacute;rea : <?php  echo $area; ?></b></p></div>
...
{
?>
<div id="caja3"><p><b>&Aacute;rea : <?php  echo $area; echo ' SITES';  ?></b></p></div>
<div id="caja3"><p style="font-size:13px;"><b>Periodo :  <?php echo $anio; echo "-"; echo $inicio; echo "-"; echo $diaII; echo "   al   "; echo $anio; echo "-"; echo $fin; echo "-"; echo $diaFF; ?></b></p></div>
<?php }
?>
</div>
...
$sql4="select sum(totalhoras) as total from ast where fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF'";
...
$sql40="select count(ast.totalhoras) as total from ast inner join usuarios on user=usuario where fecha BETWEEN '$anio-$i-$diaI' AND '$anio-$i-$diaF' ";
...
$sql1="select sum(ast.totalhoras) as total from ast where fecha BETWEEN '$anio-$i-$diaI' AND '$anio-$i-$diaF'";
...
$sql20="select count(ast.totalhoras) as total from ast where tipoact='$actividadd' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql2="select ast.tipoact,sum(ast.totalhoras) as total,nombre from ast inner join actividad on actividad.tipoact=ast.tipoact where ast.tipoact='$actividadd' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' group by ast.tipoact";
...
$sql30="select count(ast.totalhoras) as total from ast where empresa='$empresass' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' ";
...
$sql3="select ast.empresa,sum(ast.totalhoras) as total from ast where empresa='$empresass' and fecha BETWEEN '$anio-$inicio-$diaII' AND '$anio-$fin-$diaFF' group by ast.empresa ASC";
...
<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="grafico_anual_actividad_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="grafico_anual_empresa_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="grafico_anual_utilizacion_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="grafico_anual_utilizacion_depto_grafico.php">
</iframe>
</div>

<div id="grafico2">
<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="982px" height="470px" src="grafico_anual_barras_promedios_grafico.php">
</iframe>
</div>
