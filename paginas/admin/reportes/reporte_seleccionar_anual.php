...
<li><a href="reporte_seleccionar_anual.php" style="color:orange;">Reporte AST-Anual</a></li>
...
<form name="sesiones" target="_blank" action="reporte_anual_procesar.php" method="post" onsubmit="return validarproyectoseleccionar(this)" >
...
<!--
<div id="cajasrevisar"  >
<h3>Seleccione el periodo de meses para el reporte :</h3>
</div>
-->
<div id="cajasrevisar"  >

<div id="textosrevisar">
<p><b>Inicio de periodo en :</b></p>
</div>
...
<div id="otrotextos" style="width: 15%">
...
<div id="cajasrevisar" style="height: 35px" >

<div id="textosrevisar">
<p><b>Seleccione el &aacute;rea :</b></p>
</div>
<div id="selecttexrevisar" style="width: 30%">
<select name="area" size="1" style="width: 293px" >
<?php
/*
...
<option value="PROYECTOS">REPORTE GENERAL PROYECTOS SITES</option>
...
<div id="conteencabezado" style="margin-top:334px;"></div>
</div>
