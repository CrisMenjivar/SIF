...
<?php
	...
	echo 	'<!-- the chart code -->
			...
			{
   				// load the data
  				var chartData = AmCharts.loadJSON("grafico_anual_barras_promedios_data.php");
  				
  				// SERIAL CHART
                chart = new AmCharts.AmSerialChart();
                chart.dataProvider = chartData;
                chart.categoryField = "area";
                chart.startDuration = 1;
                chart.addTitle("Utilizaci\u00F3n HH anual por departamento - General",20,"#CC0000",1,true);
                ...
                graph.balloonText = "<b>[[category]]: [[value]] Horas</b>";
                graph.type = "column";
                graph.lineAlpha = 0;
                graph.fillAlphas = 1;
