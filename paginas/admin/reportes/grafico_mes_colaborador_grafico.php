...
<?php
	...
	echo 	'<!-- the chart code -->
			...
			{
  				// load the data
  				var chartData = AmCharts.loadJSON("grafico_mes_colaborador_data.php");
                ...
                chart.addTitle("Utilizaci\u00F3n HH por mes - '.$area.'",20,"#CC0000",1,true);
                ...
                graph.balloonText = "[[category]]: <b>[[value]] Horas</b>";
                graph.type = "column";
                graph.lineAlpha = 0;
...
<body>
	...
	<div id="chartdiv"  <?php if( $area == "AMM"){ echo 'style="width: 1300px; height: 500px;"';}else{ echo 'style="width: 1000px; height: 500px;"';} ?>></div>
        <!--
