...
<li><a href="#" style="color:orange;">Empresas</a>
<ul>
<li><a href="nuevaempresa.php" >Agregar Nueva Empresa</a></li>
<li><a href="nuevaempresaModificar.php" >Modificar Empresa</a></li>
<li><a href="eliminarempresa.php">Eliminar Empresa</a></li>
<li><a href="reporteempresa.php" style="color:orange;">Reporte de Empresas</a></li>
</ul>
</li>
...
<h2 align="center">Reporte de empresas registradas</h2>
<!--inicio del reporte -->
<div id="box0">
<div id="box1" style="width:994px;">
<div id="box5"> <p>No.</p></div>
<div id="box2" style="width: 219px"> <p style="width: 216px">Nombre de la empresa</p></div>
<div id="box3" style="width: 130px"> <p style="width: 136px">Grupo</p></div>
<div id="box3" style="width:89px;"> <p style="width:119px;">Estado</p></div>
<div id="box4" style="width: 166px"> <p style="width: 209px">Creado por</p></div>
<div id="box4" style="width: 168px"> <p style="width: 215px">Eliminado por</p></div>
<div id="box3" style="width:89px;"> <p style="width:128px;">Apertura</p></div>
<div id="box3" style="width:89px;"> <p style="width:89px;">Cierre</p></div>

</div>
<div id="box01" style="width:994px;">
<table border="1" style="width:994px;" cellpadding="0" cellspacing="0">
<?php
...
$grupo=$empresas['cgrupo'];
$estado=$empresas['estado'];
$fopen=$empresas['fopen'];
$fclose=$empresas['fclose'];
$creado=$empresas['creado'];
$eliminado=$empresas['eliminado'];

echo '<tr>';
echo '<td width="40px" height="20px" align="center" >'; echo $cantidad; echo'</td>';
echo '<td width="280px" height="20px" >'; echo $empresa; echo'</td>';
echo '<td width="155px" height="20px" align="center" >'; echo strtr($grupo,'_',' '); echo'</td>';
echo '<td width="110px" height="20px" align="center" >';  if($estado == "a"){ echo "Disponible";}else{ echo "No disponible";} echo'</td>';
echo '<td width="195px" height="20px" align="center" >'; echo $creado; echo'</td>';
echo '<td width="195px" height="20px" align="center" >'; echo $eliminado; echo'</td>';
