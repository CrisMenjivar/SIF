...
<li><a href="nuevaempresaModificar.php" style="color:orange;">Modificar Empresa</a></li>
<li><a href="eliminarempresa.php">Eliminar Empresa</a></li>
<li><a href="reporteempresa.php">Reporte de Empresas</a></li>
</ul>
</li>
...
<div id="contenedorform" style="left: 0px; top: 0px; height: 317px">
<form name="empresas" action="procesar_mod.php" method="post" onsubmit="return validarempresamodificar(this)" >
<div id="encabezado">
...
<div id="cajas">
<div id="inputtex">
<input type="text"  name="nombre" value="" disabled="disabled" onblur="sigla()" />
</div>
<div id="textos">
...
<div id="cajas">
<div id="selecttex">
<select name="grupo" disabled="disabled" size="1" onchange="sigla()">
<?php
