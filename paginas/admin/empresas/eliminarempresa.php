...
<li><a href="eliminarempresa.php" style="color:orange;">Eliminar Empresa</a></li>
...
<form name="sesiones" action="procesar_eliminar.php" method="post" onsubmit="return validarempresamodificar(this)" >
<div id="encabezado">
