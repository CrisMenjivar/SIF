...
<ul>
<li><a href="nuevaempresa.php" style="color:orange;">Agregar Nueva Empresa</a></li>
...
<form name="empresas" action="nuevaempresainsertar.php" method="post" onsubmit="return validarempresa(this)" >
...
<div id="cajas">
<div id="inputtex">
<input type="text"  name="nombre" value="" onblur="sigla()"/>
</div>
<div id="textos">
