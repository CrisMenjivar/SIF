...
<ul>
<li><a href="nuevodepartamento.php" style="color:orange;">Agregar Nuevo Departamento</a></li>
...
<form name="sesiones" action="nuevodepartamentoinsertar.php" method="post" onsubmit="return validardepartamento(this)" >
<div id="encabezado">
