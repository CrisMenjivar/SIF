...
var vdepar=forma.opcion;
// muestra el complemento de la url
this.curl="?departamento="+vdepar.options[vdepar.selectedIndex].value;
...
{
var texto=this.responseText;
divTabla=window.document.getElementById('subareas'); //3)muestra el resultado en este id
divTabla.innerHTML=texto;
}
}
}

var mitablajax2=new objetoAjax('GET','mod_subareas_ajax.php',muestraResultado2);
...
<li><a href="nuevodepartamento.php" >Agregar Nuevo Sub-departamento</a></li>
<li><a href="nuevodepartamentoModificar.php" >Modificar Sub-departamento</a></li>
<li><a href="eliminardepartamento.php" style="color:orange;">Eliminar Sub-departamento</a></li>
<li><a href="reportedepartamento.php">Reporte de Sub-departamentos</a></li>
...
<form name="sesiones" action="procesar_eliminar.php" method="post" onsubmit="return validardepartamentomodificar(this)" >
<div id="encabezado">
<p>Eliminar sub-departamento</p>
</div>

<div id="cajas" >
<div id="selecttex" style="width: 43%;">
<select name="opcion_area" size="1" onchange="mitablajax2.micompletar2(this.form);">
<?php
...
<div id="textos" style="width: 42%;margin-top:10px;margin-bottom:10px;">
<p style="font-size:12px;"><b>Seleccionar departamento:</b></p>
</div>
</div>
...
<div id="cajas" >
<div id="selecttex" style="width: 42%;margin-bottom:10px;margin-top:10px;">
<select name="opcion" size="1" onchange="mitablajax.micompletar(this.form);" style="width: 203px;margin-top:-10px;margin-left:-5px;">
...
<div id="desplegar" style="height: 275px">
...
<div id="textos">
<p style="font-size:12px;">Pertenece a :</p>
</div>
</div>
...
<div id="cajasbotom">
<div id="inputbotom">
<input type="submit" disabled="" value="Eliminar sub-departamento"/>
</div>
</div>
