...
var mitablajax=new objetoAjax('GET','mod_ajax.php',muestraResultado);
...
<li><a href="nuevodepartamentoModificar.php" style="color:orange;">Modificar Sub-departamento</a></li>
<li><a href="eliminardepartamento.php">Eliminar Sub-departamento</a></li>
...
<form name="sesiones" action="procesar_modificar.php" method="post" onsubmit="return validardepartamentomodificar(this)" >
<div id="encabezado">
<p>Modificar Sub-Departamento</p>
</div>
...
<option value="">Seleccione una subarea</option>
</select>
</div>
...
<div id="cajas" >
<div id="selecttex">
<select disabled="disabled" name="area" size="1">
<?php
$sql2="select * from subarea ";
