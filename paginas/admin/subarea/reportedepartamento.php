...
<title>Reporte sub-departamentos</title>
</head>
...
<li><a href="reportedepartamento.php" style="color:orange;">Reporte de Sub-departamentos</a></li>
...
<h2 align="center">Reporte de sub-departamentos registrados</h2>
<!--inicio del reporte -->
<div id="box0">
<div id="box1" style="width:950px;">
<div id="box5" style="width:44px;"> <p>No.</p></div>
<div id="box2" style="width:400px;"> <p style="width:480px;">Nombre del departamento</p></div>
<div id="box3" style="width:82px;"> <p style="width:81px;">Siglas</p></div>
<div id="box3" style="width:95px;"> <p style="width:97px;">Estado</p></div>
<div id="box4" style="width:155px;"> <p style="width:165px;">Creado por</p></div>
...
<div id="box01" style="width:950px">
<table style="width:950px;" border="1" cellpadding="0" cellspacing="0">
<?php
...
echo '<td width="500px" height="20px" style="line-height:normal;" >'; echo $nombre; echo'</td>';
