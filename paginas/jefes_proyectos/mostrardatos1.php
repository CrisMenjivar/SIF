...
$mes123=$meses-1;
//$sql="select * from proyectos inner join (SELECT fecha,descripcion,empresa,cproyecto,inicio,fin,totalhoras,tipo,DAY(fecha) as dia,nombre FROM ast inner join actividad on ast.tipoact=actividad.tipoact WHERE usuario='$userid' AND fecha BETWEEN '$years-$mes123-24' AND '$years-$meses-$diaF' order by fecha DESC, inicio DESC ) on correlativo=cproyecto ";
...
?>
<table class="fila" width="1000px" border="0" cellpadding="1" cellspacing="1" style="border-color:#000099;">
<?php
