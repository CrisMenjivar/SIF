...
<iframe frameborder="0" scrolling="yes" src="mostrardatos_excel.php" style="margin:0px 0px 0px 0px;height:301px;overflow-x:hidden;overflow-y:visibled;" target="_parent" >
</iframe>
</div>
<!--frame------------------------------------------------------------------------------------------------->
