...
$query222="select codigo from proyectos where correlativo='$codigop'";
$res222=mysql_query($query222,$conexion);
$res1222=mysql_fetch_array($res222);
$namep=$res1222['codigo'];
...
<?php
	...
	echo 	'<!-- the chart code -->
			...
			AmCharts.ready(function() 
			{
  				...
  				// load the data
  				var chartData = AmCharts.loadJSON("empresa_3_actividad2_data.php");
        	    ...
        	    chart.addTitle("Utilizaci\u00F3n HH por \u00E1rea en proyecto - '.$namep.'",20,"#CC0000",1,true);
